...
const Footer = () => {
  ...
  return (
    <footer className="bg-white dark:bg-neutral-950 text-neutral-900 dark:text-neutral-100 font-sans">
      <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="font-bold text-xl">OrchidLogos</span>
              </div>
              <p className="text-neutral-400 mb-6 max-w-md">
                Create stunning, professional logos with the power of AI. 
                Transform your brand identity in seconds with our cutting-edge technology.
              </p>
              {/* Social Links */}
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    key={social.name}
                    href={social.href}
                    className="text-neutral-400 hover:text-white transition-colors duration-200 p-2 hover:bg-neutral-800 rounded-lg"
        ...
        {/* Newsletter Section */}
        <div className="border-t border-neutral-200 dark:border-neutral-800 px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-neutral-200 dark:border-neutral-800 px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-neutral-400 text-sm">
              © {currentYear} OrchidLogos. All rights reserved.
            </p>
